<template>
  <div class="px-5">
    ...
    <div>
      ...
      あなたは制限時間内にこのサイトにサインアップすることができるでしょうか？<br />
      直観的に操作しやすいUIのルールにあえて反して、最悪なUIを作りました。
      普段意識しないで利用しているUIの大切さを実感できるでしょう。</p>
    </div>
    <Row class="pt-5 d-flex align-items-center">
      <Col col="9">
      <p class="fs-3 text-white">右矢印を押して始めてください
